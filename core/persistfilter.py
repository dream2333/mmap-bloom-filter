...
class PersistFilter(object):
    __slots__ = "bit_array_size", "hash_func_count", "bit_array"
    ...
    def __init__(self, filename: str, num: int, error_rate: float):
        ...
        print(f"过滤器大小：{cost_gigabytes:.3f}GB "
    ...
    def add(self, value: str):
        ...
        :param value: 待插入的元素
        """
        for index in self.get_offset_index(value, self.hash_func_count):
            # 将对应的bit位置为1
    ...
    def get_offset_index(self, value: str, hash_count: int):
        """
